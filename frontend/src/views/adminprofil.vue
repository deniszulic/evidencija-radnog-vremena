...
<br>
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="email" v-model="email" required>
  </div><br>
  <div class="form-group">
    <label for="exampleInputPassword11">Password</label><br>
    <input type="password" class="form-control" id="exampleInputPassword11" placeholder="Lozinka" v-model="password" required>
  </div><br>
